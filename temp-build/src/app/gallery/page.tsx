...
import collagesDataJson from '../../../data/collages.json';

export default function GalleryPage() {
  const siteSettings = siteDataJson as SiteSettings;
  const allCollages = collagesDataJson as Collage[];
  const [filteredCollages, setFilteredCollages] = useState<Collage[]>(allCollages);
