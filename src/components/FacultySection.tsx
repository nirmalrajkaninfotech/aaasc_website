		...
		<section className="py-16 bg-[var(--theme-bg-secondary)] w-full">
			<div className="container mx-auto px-4">
				<div className="text-center mb-12">
					...
					<p className="text-xl text-[var(--theme-text-secondary)]">Explore departments and staff information</p>
				</div>
						...
						<button
							...
							className={`px-6 py-2 rounded-full transition-all duration-200 ${
								activeId === item.id
									...
									: 'bg-[var(--theme-bg-card)] text-blue-700 border border-blue-600 hover:bg-blue-50 shadow-sm hover:shadow-md'
							}`}
						>
							{item.title}
						</button>
