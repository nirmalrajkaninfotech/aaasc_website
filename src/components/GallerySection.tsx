    ...
    return (
      <section className="py-12">
        <div className="container mx-auto text-center">
          ...
          <p className="text-[var(--theme-text-secondary)]">No images available.</p>
        </div>
      </section>
    );
  }
      ...
      <div className="container mx-auto">
        ...
        <div className="flex flex-wrap justify-center items-center gap-8">
          {publishedItems.map(item => (
            <div key={item.id} className="flex flex-col items-center w-full max-w-5xl mx-auto bg-[var(--theme-bg-card)] rounded shadow-lg overflow-hidden">
              ...
              <div className="p-4 w-full text-center">
                ...
                {item.description && <p className="text-[var(--theme-text-secondary)] text-sm">{item.description}</p>}
              </div>
            </div>
          ))}
        </div>
